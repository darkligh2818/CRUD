...
<div class="row">
    <div class="col mb-3">
        ...
        <input type="text" name="product_code" class="form-control" placeholder="Product_code" value="{{ $product->product_code }}" readonly>
    </div>
    <div class="col mb-3">
...
<div class="row">
    <div class="col mb-3">
        ...
        <input type="text" name="created_at" class="form-control" placeholder="Created_at" value="{{ $product->created_at }}" readonly>
    </div>
    <div class="col mb-3">
        <label class="form-label">Updated At</label>
        <input type="text" name="updated_at" class="form-control" placeholder="Updated_at" value="{{ $product->updated_at }}" readonly>
    </div>
</div>
@endsection